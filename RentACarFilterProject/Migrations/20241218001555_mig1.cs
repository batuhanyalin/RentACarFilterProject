...
namespace RentACarFilterProject.Migrations
{
    ...
    public partial class mig1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Schedules_Locations_DropOffLocationId",
                        column: x => x.DropOffLocationId,
                        principalTable: "Locations",
                        principalColumn: "LocationId");
                    table.ForeignKey(
                        name: "FK_Schedules_Locations_PicUpLocationId",
                        column: x => x.PicUpLocationId,
                        principalTable: "Locations",
                        principalColumn: "LocationId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Schedules_DropOffLocationId",
                table: "Schedules",
                column: "DropOffLocationId");

            migrationBuilder.CreateIndex(
                name: "IX_Schedules_PicUpLocationId",
                table: "Schedules",
                column: "PicUpLocationId");
        }
